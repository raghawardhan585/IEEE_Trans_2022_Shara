...
n_x_nn_nodes = 8  # max width_limit -4 works well
...
dict_training_params = {'step_size_val': 0.5, 'train_error_threshold': float(1e-20),'valid_error_threshold': float(1e-6), 'max_epochs': 1000, 'batch_size': batch_size} #80000
ls_dict_training_params.append(dict_training_params)
dict_training_params = {'step_size_val': 0.3, 'train_error_threshold': float(1e-10),'valid_error_threshold': float(1e-6), 'max_epochs': 1000, 'batch_size': batch_size}
ls_dict_training_params.append(dict_training_params)
dict_training_params = {'step_size_val': 0.1, 'train_error_threshold': float(1e-10), 'valid_error_threshold': float(1e-7), 'max_epochs': 1000, 'batch_size': batch_size}
ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.08, 'train_error_threshold': float(1e-8), 'valid_error_threshold': float(1e-8), 'max_epochs': 10000, 'batch_size': batch_size}
# ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.05, 'train_error_threshold': float(1e-10), 'valid_error_threshold': float(1e-8), 'max_epochs': 10000, 'batch_size': batch_size}
# ls_dict_training_params.append(dict_training_params)
...
# ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.005, 'train_error_threshold': float(1e-10), 'valid_error_threshold': float(1e-8), 'max_epochs': 5000, 'batch_size': batch_size}
# ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.001, 'train_error_threshold': float(1e-10), 'valid_error_threshold': float(1e-8), 'max_epochs': 5000, 'batch_size': batch_size}
# ls_dict_training_params.append(dict_training_params)
